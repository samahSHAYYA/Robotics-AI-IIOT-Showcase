 ...
 * @author: Samah SHAYYA
 * @date: 19-Mar-2026
 * @brief: Distance sensor class declaration.
 * @see: src/core-platform/ReadMe.md
 */

#ifndef CORE_PLATFORM_SENSORS_DISTANCE_SENSOR_HPP
#define CORE_PLATFORM_SENSORS_DISTANCE_SENSOR_HPP
...
class DistanceSensor : public Sensor<double, MeasureId::Distance> {
 public:
  using Sensor::Sensor;
  
  DistanceSensor(std::string name, double value, std::string_view unitSymbol);
...
#endif  // CORE_PLATFORM_SENSORS_DISTANCE_SENSOR_HPP
